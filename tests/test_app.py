...
class TestScraperUnit:
    def test_scraper_initialization(self):
        ...
        assert scraper.api_base == "https://www.petconnect.be/_api/cloud-data/v2/items/query"
    ...
    def test_process_pet_data(self):
        ...
        assert result['full_url'] == 'https://www.petconnect.be/animals/buddy-golden-retriever'
